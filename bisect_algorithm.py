...
print(bisect.bisect_left(sorted(list_to_be_changed), element_to_be_inserted_into_list)) # the index of inserted element is 5 - the index of existed element 20 is 4, replaced with inserted one 4
print(bisect.bisect_right(sorted(list_to_be_changed), element_to_be_inserted_into_list)) # the same as for bisect
